...
export const Icon = ({ name, size = 24 }) => {
  ...
  switch (name) {
    ...
    case 'tower':
      return (
        <svg {...p} {...S}>
          <path d="M7 3h10l-1.5 7h-7z" />
          <path d="M8.5 10l-1 11M15.5 10l1 11" />
          <path d="M6 21h12M9 15h6" />
        </svg>
      )
    case 'water':
      return (
    ...
    case 'pipe':
      return (
        <svg {...p} {...S}>
          <path d="M3 10v4a2 2 0 0 0 2 2h4v3h6v-3h1a4 4 0 0 0 4-4V8" />
          <path d="M3 10h6V7H3zM20 8h-4" />
        </svg>
      )
    case 'trash':
      return (
    ...
    case 'hazard':
      return (
        <svg {...p} {...S}>
          ...
          <path d="M9.6 15.5 12 11.4l2.4 4.1zM12 16.6h.01" />
        </svg>
      )
    case 'scrap':
      return (
        <svg {...p} {...S}>
          ...
          <rect x="12.5" y="4.5" width="6" height="6" rx="1" transform="rotate(20 15.5 7.5)" />
